...
const drawerVariants = {
    ...
    visible: {
        ...
        transition: {
            ...
            scaleY: { duration: 0.25, ease: [0.16, 1, 0.3, 1] as const },
    ...
    exit: {
        ...
        transition: {
            ...
            scaleY: { duration: 0.2, ease: [0.4, 0, 0.2, 1] as const },
...
export function Navbar() {
    ...
    // Prevent body scroll when menu open (deferred to avoid blocking click)
    useEffect(() => {
    ...
    return (
        <motion.nav
            ...
            className="absolute top-4 left-1/2 -translate-x-1/2 z-50 w-[95%] max-w-5xl border border-white/10 bg-[#0A0A0A]/60 backdrop-blur-md shadow-[0_0_20px_rgba(168,85,247,0.15)] ring-1 ring-white/5 rounded-2xl"
        >
            <div className="absolute inset-0 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.1)] pointer-events-none rounded-2xl" />
            ...
            <AnimatePresence>
                {isMenuOpen && (
                    <motion.div
                        ...
                        animate="visible"
                        exit="exit"
                        className="lg:hidden border-t border-white/10 px-4 pb-5 pt-3 origin-top"
